...
public class ArtistByNameRow {
    ...
    public ArtistByNameRow(final UUID id, final String name, final Map<UUID, String> genres) {
        this.id = id;
        this.name = name;
        this.genres = genres;
    }

    public ArtistByNameRow(final UUID id, final String name, final Set<GenreDto> genres) {
        this.id = id;
        this.name = name;
